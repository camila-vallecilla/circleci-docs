...
Please reference exhibit C within your terms of contract and our https://circleci.com/outer/legal/enterprise-license-agreement.pdf[standard license agreement] for our complete security and privacy disclosures.
